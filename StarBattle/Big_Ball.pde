//Big meteors size and location
class BBall {
  float size = 100; //the size for the meteors in this class
  PVector location = new PVector (random(size, width - size), random(-150, -50)); //define the 
  ...
  //define the exact x, y and velocity in each frame
